...
namespace AnimationLibrary
{
    ...
    {
        public static void Draw(this SpriteBatch batch, Animation animation, Vector2 position, Vector2 scale, Color? color = null, float rotation = 0, float layerDepth = 0)
        {
