...
namespace MonogameExtensions
{
    public static class Primitives2D
    {
        ...
        public static void DrawCross(this SpriteBatch spriteBatch, Vector2 pos, Color color)
        {
            DrawLine(spriteBatch, pos.X - 4, pos.Y, pos.X - 1, pos.Y, color);
            DrawLine(spriteBatch, pos.X + 0, pos.Y, pos.X + 3, pos.Y, color);
            DrawLine(spriteBatch, pos.X, pos.Y - 3, pos.X, pos.Y - 0, color);
            DrawLine(spriteBatch, pos.X, pos.Y + 1, pos.X, pos.Y + 4, color);
        }
